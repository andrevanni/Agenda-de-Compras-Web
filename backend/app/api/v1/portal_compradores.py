"""
Endpoint para envio de convite de acesso a compradores, acessível pelo portal do cliente.
Aceita qualquer JWT Supabase válido (admin ou comprador logado).
"""
...
router = APIRouter(prefix="/portal/compradores", tags=["portal-compradores"])
...
def enviar_convite_portal(
    comprador_id: UUID,
    authorization: str | None = Header(default=None),
) -> dict:
    """Envia convite de acesso ao comprador. Requer JWT válido do portal."""
    _validate_jwt(authorization)
...
<div style="max-width:600px;margin:0 auto;">
  ...
  <div style="background:#ffffff;padding:28px 32px;border-radius:0 0 12px 12px;box-shadow:0 4px 6px rgba(0,0,0,0.07);">
    ...
    <p style="margin:24px 0 0;font-size:13px;color:#94a3b8;border-top:1px solid #f1f5f9;padding-top:16px;">
      Em caso de dúvidas, entre em contato com o administrador.<br>Não responda a este e-mail.
    </p>
  </div>
</div>
</body>
