...
**Validação do v75 (27/jul)** — confirmar com a Total Socorro que a compradora conseguiu excluir a série inteira pela UI: recarregar o portal (rodapé deve mostrar v75), abrir o compromisso recorrente, marcar **"Toda a série (17)"** e Excluir. Se o rodapé continuar em versão antiga (SW preso), usar `/?limpar=1`. Conferir depois no banco que a série `cb6286a9-5de6-4a03-b1a1-bf461dc9a6dc` (tenant `57e02e64-d14d-4049-8d80-2618df06a546`) zerou. Minors que sobraram do review de 21/jul: backfill usa `getSettings().tenantId` em vez do tenant capturado; `openGenericEventDetail` faz 2 fetches paginados onde 1 bastaria.
